...
public class Quiz extends JFrame implements ActionListener{
	...
	String[] questions = 	{
		...
		"Which of the following is used for comments in Java?",
        "Which of the following keyword is used for abstract class?"
	};
	String[][] options = 	{
		{   
            "print(\"Hello World\")",
	...
	public Quiz() {
		...
		answer_labelA.setFont(new Font("Arial",Font.PLAIN,16));
		
		answer_labelB.setBounds(125,230,500,100);
		answer_labelB.setBackground(new Color(50,50,50));
		answer_labelB.setForeground(new Color(25,255,0));
		answer_labelB.setFont(new Font("Arial",Font.PLAIN,16));
		
		answer_labelC.setBounds(125,330,500,100);
		answer_labelC.setBackground(new Color(50,50,50));
		answer_labelC.setForeground(new Color(25,255,0));
		answer_labelC.setFont(new Font("Arial",Font.PLAIN,16));
		
		answer_labelD.setBounds(125,430,500,100);
		answer_labelD.setBackground(new Color(50,50,50));
		answer_labelD.setForeground(new Color(25,255,0));
		answer_labelD.setFont(new Font("Arial",Font.PLAIN,16));
